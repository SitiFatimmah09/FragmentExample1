package id.ac.polbeng.sifa.fragmentexample1
...
import id.ac.polbeng.sifa.fragmentexample1.databinding.BookdesriptionBinding


class BookDescription : Fragment()  {

    private var _binding: BookdesriptionBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = BookdesriptionBinding.inflate(inflater, container,
            false)
